...
# wykres 2 zmiennych - Education wg MonthlyIncome:
...
ggplot(tabela_knn, aes(x=Age, y=MonthlyIncome, color=Gender)) +
  ...
  labs(
    ...
    y = "Miesięczne zarobki")
```
# wykres odległości od pracy w zależności do satysfakcji z pracy:
 
```{r} 
ggplot(tabela_knn, aes(x=EducationField, y=MonthlyIncome)) +
  geom_point() +
  geom_smooth(method="lm")
```
