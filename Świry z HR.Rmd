...
#do usuniecia W celu znalezenia poszczególnych wierszy zawierającyh braki danych,
...
ggplot(tabela_knn, aes(x = Attrition, y = JobSatisfaction )) +
  ...
  theme_minimal()
```
### **Wykres 9 - Zależność liczby lat od ostatniego awansu (YearsSinceLastPromotion) względem odejść (attrition)**
### arrition względem cech ludzi działów, 
### jak sie rozklada dochod satysfakcja 

# testowski czy dziala znowu